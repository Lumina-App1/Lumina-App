...
class AppLocalizations {
  ...
  static final Map<String, String> _urduStrings = {
    ...
    'welcome_home': 'ہوم پیج پر خوش آمدید۔ میں آپ کی کس طرح مدد کر سکتا ہوں؟ آبجیکٹ ڈیٹیکشن کے لیے آبجیکٹ ڈیٹیکشن منتخب کریں۔ کسی خاص چیز کو تلاش کرنے کے لیے ٹارگٹ سرچ منتخب کریں۔ سیٹنگز تبدیل کرنے کے لیے سیٹنگز منتخب کریں۔',
    'home_title': 'ہوم',
    'home_subtitle': 'آج میں آپ کی کس طرح مدد کر سکتا ہوں؟',
    'object_detection': 'آبجیکٹ کی شناخت',
    'object_detection_sub': 'اپنے ارد گرد کی چیزوں کو پہچانیں',
    'target_search': 'ٹارگٹ تلاش کریں',
    ...
    'target_search_title': 'ٹارگٹ آبجیکٹ تلاش کریں',
    ...
    'english': 'انگریزی',
    'urdu': 'اردو',
    'settings_announce': 'آپ سیٹنگز پیج پر ہیں۔ دستیاب اختیارات: زبان، آواز کی بلندی، ہائی کنٹراسٹ، بڑا متن، اباؤٹ، اور ہیلپ۔',
